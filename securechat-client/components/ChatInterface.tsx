...
export default function ChatInterface() {
  ...
  const initializeUser = async () => {
    try {
      ...
      await apiClient.ensureRegistered();
    ...
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="hidden w-80 flex-col border-r border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800 md:flex">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
          ...
          <button
            onClick={logout}
            className="flex-shrink-0 rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200"
            title="Logout"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
